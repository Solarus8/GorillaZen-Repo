<?php /* Smarty version Smarty-3.1.13, created on 2013-08-13 12:23:47
         compiled from "/var/www/sites/gorillazen/public/themes/theme696/password.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1911349212520a5d93e62b20-84411507%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cd4e1f4b7755d15ed5b7607823802433c67e5b7' => 
    array (
      0 => '/var/www/sites/gorillazen/public/themes/theme696/password.tpl',
      1 => 1375718859,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1911349212520a5d93e62b20-84411507',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_520a5d93eeb130_55784513',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_520a5d93eeb130_55784513')) {function content_520a5d93eeb130_55784513($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/sites/gorillazen/public/tools/smarty/plugins/modifier.escape.php';
?>
...
<h1><span><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
</span></h1>
...
" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		<p class="text">
			...
			<input type="email" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['email'], 'htmlall', 'UTF-8'));?>
<?php }?>" />
		</p>
		<p class="submit">
...
<p class="clear clearfix">
    <a class="button fr" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
