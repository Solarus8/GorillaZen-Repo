	...
	{if $category->id AND $category->active}
		...
		{/if}
			...
			{if strlen($category->description) > 480}
				<p class="cat_desc clearfix" id="category_description_short">{$category->description|truncate:480}&nbsp;<span onclick="$('#category_description_short').hide(); $('#category_description_full').show();" class="lnk_more_cat">{l s='More'} </span></p>
