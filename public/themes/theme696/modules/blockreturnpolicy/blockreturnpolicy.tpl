...
<!-- MODULE Block return-policy -->
    <section id="return-policy" class="block products_block column_box">
	<h4><span>{l s='Return Policy' mod='blockreturnpolicy'}</span><span class="column_icon_toggle"></span></h4>
