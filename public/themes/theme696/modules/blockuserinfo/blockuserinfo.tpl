...
<section class="blockuserinfo header-box">
		...
		<div>
			<div id="logout">
			<a href="{$link->getPageLink('index', true, NULL, "mylogout")}" title="{l s='Log out' mod='blockuserinfo'}" class="logout" rel="tooltip" data-placement="bottom" data-original-title="first tooltip"><span id='login'>LogOut</span></a>
		    </div>
			<div id="header_user_info">
			 {l s='Welcome,' mod='blockuserinfo'}
			<a href="http://www.gorillazen.com/index.php?controller=my-account"> <span>{$customerName}</span></a>
