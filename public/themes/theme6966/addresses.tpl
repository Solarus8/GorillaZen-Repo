...
<div class="addresses titled_box">
	...
	{foreach from=$multipleAddresses item=address name=myLoop}
		<ul class="address clearfix {if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if}">
