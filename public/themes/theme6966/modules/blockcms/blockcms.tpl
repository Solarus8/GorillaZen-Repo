...
<section class="block blockcms_footer span3">
		...
		<ul class="list-footer toggle_content clearfix">
			{if !$PS_CATALOG_MODE}<li class="first_item"><a href="{$link->getPageLink('prices-drop')}" title="{l s='Return Policy' mod='blockcms'}">{l s='Return Policy' mod='blockcms'}</a></li>{/if}
